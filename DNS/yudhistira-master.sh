...
echo 'zone "3.229.192.in-addr.arpa" {
    type master;
    file "/etc/bind/i02/3.229.192.in-addr.arpa";
};' | tee -a /etc/bind/named.conf.local

cp /etc/bind/db.local /etc/bind/i02/3.229.192.in-addr.arpa
...
@       IN      SOA     i02.com. root.i02.com. (
                     2023101001         ; Serial
                        ...
                        2419200         ; Expire
                         604800 )       ; Negative Cache TTL
;
3.229.192.in-addr.arpa.     IN      NS      i02.com.
4                           IN      PTR     abimanyu.i02.com.' | tee /etc/bind/i02/3.229.192.in-addr.arpa
